...
const PurchaseOrder = () =>{
    return (
        ...
        <section className="w-100 p-6">
          ...
          <p className="text-gray-500">OrdenCompra/<NavLink to="/" className="cursor-pointer text-sky-500 font-medium">Inicio</NavLink></p>
          </div>
          <div className="bg-blue-500 hover:bg-blue-600 cursor-pointer text-white p-2 rounded w-56">
          <NavLink to="/crearOrdenCompra" className="flex"><FaIcons.FaPlusCircle className="mx-2 m-1"/>Crear Orden de Compra</NavLink>
          </div>
        </section>
          <section className=" shadow-lg rounded w-100 h-auto m-3 border border-gray-300 bg-slate-50">
               ...
               <a className="flex font-medium p-2 mt-3 px-6 w-100 cursor-pointer rounded bg-blue-500 hover:bg-blue-600 text-white text-center"><FaIcons.FaSearch className="mx-2 m-1"/>Buscar</a>
               </div>
               </div>
